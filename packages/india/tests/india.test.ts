...
import { railRoute, resolveStation, registerStations } from 'railroute-ts';
import { INDIA_STATIONS } from '../src/index.js';
...
describe('India network', () => {
  it('routes New Delhi -> Mumbai CSMT by Indian Railways station codes (~1,384 km)', async () => {
    const { INDIA_NETWORK } = await import('../src/index.js');
